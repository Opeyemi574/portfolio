      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            using firebase. Users are able to sign in with a google account using their
            google signIn option.This is made possble by creating a firestore cloud storage
            database at the time of user registration.
          </p>
          <a
            href='https://github.com/Opeyemi574/chat-app'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://ope-chat-app.netlify.app/'
            target='_blank'
            rel='noreferrer'
          >
